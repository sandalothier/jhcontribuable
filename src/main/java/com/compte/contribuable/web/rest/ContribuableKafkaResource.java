...
@RestController
@RequestMapping("/api/contribuable-kafka")
public class ContribuableKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ContribuableKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ContribuableKafkaResource(KafkaProperties kafkaProperties) {
